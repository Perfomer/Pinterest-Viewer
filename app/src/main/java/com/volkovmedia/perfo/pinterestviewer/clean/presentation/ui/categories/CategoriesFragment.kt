...
import com.volkovmedia.perfo.pinterestviewer.clean.presentation.ui.categories.adapter.CategoriesAdapter
import com.volkovmedia.perfo.pinterestviewer.clean.presentation.ui.categories.adapter.CategoryDiffUtilCallback
...
class CategoriesFragment : NavigationFragment() {
    ...
    private val categoriesAdapter = CategoriesAdapter(CategoryDiffUtilCallback(), GridLayoutManager(context, 3), ::onCategoryClick)
