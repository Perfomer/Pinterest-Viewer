...
import com.volkovmedia.perfo.pinterestviewer.clean.presentation.screens.details.comments.CommentsAdapter
...
class DetailsFragment : NavigationFragment() {
    ...
    private fun FeedItem.render() {
        ...
        details_image.load(imageUrl, centerInside = true)
    ...
    private fun FeedItemDetails.render() {
        ...
        val fullImage = async {
            fullImageUrl.loadImage(this@DetailsFragment.context!!, centerInside = true)
        }
        ...
        with(channel) {
            ...
            details_channel_thumbnail.load(thumbnailsUrl, withPlaceHolder = true, circleCrop = true)
